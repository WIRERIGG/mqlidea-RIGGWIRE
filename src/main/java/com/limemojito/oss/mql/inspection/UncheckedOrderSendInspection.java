        ...
        for (PsiElement child : file.getChildren()) {
            ...
            if (child instanceof MQL4FunctionElement func && !func.isDeclaration()) {
                ...
                if (BracketBlockTokenWalker.containsFunctionCall(body, "OrderSend")) {
                    if (!BracketBlockTokenWalker.containsIdentifier(body, "retcode")
                            && !BracketBlockTokenWalker.containsIdentifier(body, "GetLastError")
                            && !BracketBlockTokenWalker.containsPattern(body, "\\bresult\\.retcode\\b")) {
