...
public class UnsafeArrayCopyInspection extends MQL5SafetyInspectionBase {

    private static final String MESSAGE = "ArrayCopy() without size validation — verify source and destination sizes";
