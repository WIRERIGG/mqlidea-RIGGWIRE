...
import com.limemojito.oss.mql.parser.parsing.util.ParsingScope;
import com.limemojito.oss.mql.parser.parsing.util.ParsingUtils;
import com.limemojito.oss.mql.parser.parsing.util.PatternMatcher;
import com.limemojito.oss.mql.psi.MQL4Elements;
import com.limemojito.oss.mql.psi.MQL4TokenSets;
import com.limemojito.oss.mql.util.ObjectUtils;
...
import static com.limemojito.oss.mql.parser.parsing.FunctionsParsing.FunctionParsingResult.Definition;
import static com.limemojito.oss.mql.parser.parsing.FunctionsParsing.FunctionParsingResult.NotMatched;
import static com.limemojito.oss.mql.parser.parsing.util.ParsingErrors.UNEXPECTED_TOKEN;
...
import static com.limemojito.oss.mql.parser.parsing.util.ParsingUtils.hasElementInRange;
import static com.limemojito.oss.mql.parser.parsing.util.ParsingUtils.matchSequenceN;
...
public class FunctionsParsing implements MQL4Elements {
    ...
    public static FunctionParsingResult parseFunction(PsiBuilder b, int l, @Nullable FunctionParsingResult expectedResult) {
        ...
        try {
            ...
            m.done(actualResult == Declaration ? MQL4StubElements.FUNCTION_DECLARATION : MQL4StubElements.FUNCTION);
        }
        return actualResult;
    }
    ...
    private static boolean parseConstructorFieldsInitBlock(PsiBuilder b, int l) {
        ...
        try {
            while (b.getTokenType() != L_CURLY_BRACKET) {
                ...
                if (!parseBracketsBlock(b, l, true)) {
