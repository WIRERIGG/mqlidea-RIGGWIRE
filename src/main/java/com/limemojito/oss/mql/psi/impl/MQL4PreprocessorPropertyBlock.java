...
import static com.limemojito.oss.mql.psi.MQL4Elements.CHAR_LITERAL;
import static com.limemojito.oss.mql.psi.MQL4Elements.COLOR_CONSTANT_LITERAL;
import static com.limemojito.oss.mql.psi.MQL4Elements.COLOR_STRING_LITERAL;
import static com.limemojito.oss.mql.psi.MQL4Elements.DOUBLE_LITERAL;
import static com.limemojito.oss.mql.psi.MQL4Elements.FALSE_KEYWORD;
import static com.limemojito.oss.mql.psi.MQL4Elements.IDENTIFIER;
...
import static com.limemojito.oss.mql.psi.MQL4Elements.TRUE_KEYWORD;
...
public class MQL4PreprocessorPropertyBlock extends MQL4PsiElement {
    ...
    public void sync() {
        ...
        keyNode = node.findChildByType(IDENTIFIER);
